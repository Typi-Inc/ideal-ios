		...
		<View>
			<View style={{alignItems:'center',justifyContent:'space-between',flexDirection:'row',height:40*k}}>
				<View style={{...center,flexDirection:'row'}}>
					<Image source={{uri:this.props.uri}} style={{height:30*k,width:30*k,marginLeft:5*k}}/>
					<Text style={{marginLeft:10*k,fontSize:14*k,fontWeight:'700'}}>{this.props.author}</Text>
				</View>
