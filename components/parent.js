  ...
  getInitialState() {
    return {
      ...
      annotations: [{
        ...
        annotationImage: {
          url: 'http://cdn.wonderfulengineering.com/wp-content/uploads/2014/09/Best-Wallpapers-20.jpg',
          height: 100,
          width: 100
        },
        id: 'marker1'
  ...
  render: function() {
    ...
    return (
      <View style={styles.container}>
        ...
        <Text style={styles.text} onPress={() => this.setCenterCoordinateZoomLevelAnimated(mapRef, 43.238949, 76.8888, 14)}>
        ...
        <Mapbox
          ...
          ref={mapRef}
          accessToken={'pk.eyJ1IjoiYm5kamFtYm5kIiwiYSI6ImNpaXNkYTR3ZjAwOW92dmtza2k3eHVoM2cifQ.j654KYUponH69isAO3GMEA'}
